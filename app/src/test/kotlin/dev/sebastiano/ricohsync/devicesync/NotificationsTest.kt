...
import dev.sebastiano.ricohsync.di.TestGraphFactory
...
class NotificationsTest {
    ...
    private lateinit var testGraph: dev.sebastiano.ricohsync.di.TestGraph
    ...
    fun `notification has refresh and stop actions`() {
        ...
        assertEquals(
            dev.sebastiano.ricohsync.devicesync.MultiDeviceSyncService.REFRESH_REQUEST_CODE,
            pendingIntentFactory.calls[0].requestCode,
        )
        assertEquals(
            dev.sebastiano.ricohsync.devicesync.MultiDeviceSyncService.STOP_REQUEST_CODE,
