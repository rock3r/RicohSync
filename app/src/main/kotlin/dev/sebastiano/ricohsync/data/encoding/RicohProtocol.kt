...
object RicohProtocol {
    ...
    /** @see dev.sebastiano.ricohsync.vendors.ricoh.RicohProtocol.DATE_TIME_SIZE */
    const val DATE_TIME_SIZE = 7

    /** @see dev.sebastiano.ricohsync.vendors.ricoh.RicohProtocol.LOCATION_SIZE */
    const val LOCATION_SIZE = 32

    /** @see dev.sebastiano.ricohsync.vendors.ricoh.RicohProtocol.encodeDateTime */
    fun encodeDateTime(dateTime: ZonedDateTime): ByteArray =
        dev.sebastiano.ricohsync.vendors.ricoh.RicohProtocol.encodeDateTime(dateTime)
    ...
    /** @see dev.sebastiano.ricohsync.vendors.ricoh.RicohProtocol.encodeLocation */
    fun encodeLocation(location: GpsLocation): ByteArray =
        dev.sebastiano.ricohsync.vendors.ricoh.RicohProtocol.encodeLocation(location)
    ...
    /** @see dev.sebastiano.ricohsync.vendors.ricoh.RicohProtocol.formatDateTimeHex */
    @OptIn(ExperimentalStdlibApi::class)
    fun formatDateTimeHex(bytes: ByteArray): String =
        dev.sebastiano.ricohsync.vendors.ricoh.RicohProtocol.formatDateTimeHex(bytes)

    /** @see dev.sebastiano.ricohsync.vendors.ricoh.RicohProtocol.formatLocationHex */
    @OptIn(ExperimentalStdlibApi::class)
    fun formatLocationHex(bytes: ByteArray): String =
        dev.sebastiano.ricohsync.vendors.ricoh.RicohProtocol.formatLocationHex(bytes)
}
